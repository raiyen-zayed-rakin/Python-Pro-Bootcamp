...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.score_label = Label(text="Score: 0", background=THEME_COLOR, foreground="white", font=QUESTION_FONT)
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.question_text, text=f"Good Job Phucker\nFinal score: {self.quiz.score}", fill=THEME_COLOR)
